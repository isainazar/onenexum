...
const B_EX_3 = () => {
  ...
  const finish = () => {
  completeExB(data,UserDispatch,navigate,3);
  };
  const retake = () => {
    setComplete(false);
    setSteps(0);
    ...
    <>
      <section className="main-view">
        ...
        >
          {steps === 0 && (
            <>
              <h2 className="title_exercise">¿Cómo se practica la técnica?</h2>
              <section className="exercise-description">
                <ol>
                  <li>
                    Primero debes <strong>detectar</strong> cual es la situación
                    que está generando emociones adversas que necesitas que se
                    regulen. 
                  </li>
                  <li>
                    Procura <strong>concentrarte en los detalles</strong> para
                    que el ejercicio sea eficiente
                  </li>
                  <li>
                    Empezaremos haciendo respiraciones lentas y pausadas.{" "}
                    <strong>Inhala y exhala</strong> suavemente. Procura seguir
                    el sonido de fondo.
                  </li>
                  <li>
                    Ahora <strong>cierra los ojos y escucha </strong>qué sonidos
                    hay a tu alrededor.
                  </li>
                  <li>
                    <strong>Identifícate</strong> con aquellos sonidos que
                    escuches mejor y relájate.
                  </li>
                  <li>
                    A continuación,<strong> observa </strong>detenidamente la
                    imagen que ves en pantalla y presta atencion a 3 objetos que
                    más te llamen la atención, concéntrate en sus colores y su
                    forma.
                  </li>
                </ol>
              </section>
